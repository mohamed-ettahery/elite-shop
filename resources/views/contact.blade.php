        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form name="contactForm" id="contactForm" method="POST" action="{{ route('contact.submit') }}">
                        @csrf
                        ...
                        <div>
                            <button class="btn btn-primary py-2 px-4" type="submit">Envoyér Message</button>
                        </div>
                    </form>
            ...
            <div class="col-lg-5 mb-5">
                <div class="bg-light p-30 mb-30">
                    <iframe style="width: 100%; height: 250px;"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6952058.921235388!2d-12.445537231996886!3d31.700593887554767!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b88619651c58d%3A0xd9d39381c42cffc3!2sMaroc!5e0!3m2!1sfr!2sma!4v1684934542310!5m2!1sfr!2sma"
                ...
                <div class="bg-light p-30 mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>{{ $site_phone }}</p>
                </div>
            </div>
        </div>
    </div>
